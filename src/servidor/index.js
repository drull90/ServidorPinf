...
async function crearDatosDePrueba() {
    ...
    await db.collection('usuarios').doc('CS35ZglArCUCU29xzWb7o2QvLw33').set(data);
    ...
    data = {
        "uuid": "CS35ZglArCUCU29xzWb7o2QvLw33"
    };
    ...
    await db.collection('expedientes').doc('CS35ZglArCUCU29xzWb7o2QvLw33').set(data);
    ...
    data = {
        "21714001": {
            "HGFOTOEW": "AAAAA",
            "CS35ZglArCUCU29xzWb7o2QvLw33": "BBB"
        },
        "21714002": {
    ...
    await db.collection('matricula').doc('CS35ZglArCUCU29xzWb7o2QvLw33').set(data, {merge: true});

    data = {
        "2007003": {
            "HGFOTOEW": "CS35ZglArCUCU29xzWb7o2QvLw33-HGFOTOEW-2007003",
            "CS35ZglArCUCU29xzWb7o2QvLw33": "CS35ZglArCUCU29xzWb7o2QvLw33-HGFOTOEW-2007003"
        }
    };
    ...
    await db.collection('amistades').doc('CS35ZglArCUCU29xzWb7o2QvLw33').set(data);

    data = {
        "CS35ZglArCUCU29xzWb7o2QvLw33": true
    };
    ...
    await db.collection('peticionesEnviadas').doc('CS35ZglArCUCU29xzWb7o2QvLw33').set(data);
    ...
    await db.collection('peticionesRecibidas').doc('CS35ZglArCUCU29xzWb7o2QvLw33').set(data);
    ...
    data = {
        "usuario": "HGFOTOEW",
        "destinatario": "CS35ZglArCUCU29xzWb7o2QvLw33",
        "estado": "Suspende",
        "calificacion": 3,
        "pinfCoins": 10
    };
    ...
    await db.collection('estadisticas').doc('CS35ZglArCUCU29xzWb7o2QvLw33').set(data);

    // crear historial apuestas

    // data = {
    //     "CS35ZglArCUCU29xzWb7o2QvLw33-HGFOTOEW-2007005": {
    ...
    //         "pinfcoinsGanados": 20
    //     },
    //     "CS35ZglArCUCU29xzWb7o2QvLw33-HGFOTOEW-2007006": {
    //         "destinatario": "HQWSSAZC",
    //         "estado": "aprueba",
    //         "calificacion": 8,
    //         "estadoFin": "aprobado",
    ...
    // await db.collection('historialApuestas').doc('CS35ZglArCUCU29xzWb7o2QvLw33').set(data);
    ...
    data = {
        ...
        author: "pepe",
        authorID: "CS35ZglArCUCU29xzWb7o2QvLw33"
    };
